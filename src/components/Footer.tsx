  ...
  return (
    <footer className='bg-[#171C20] h-[269px] flex align-middle justify-center py-[40px] px-[120px] mt-20 '>
      <section>
        ...
        <center className=' flex mt-5 gap-x-10 md:ml-36  text-center'>
        ...
        <div className='flex text-center text-[#E4E7EC] gap-x-5 md:ml-44 mt-7'> <img src='/footer/copy.svg' alt='copy' />Copyright 2024</div>
      </section>
    </footer>
  )
}