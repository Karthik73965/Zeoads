...
export default function WhyZeoAds({ }: Props) {
    return (
        <main className='px-20 pb-10 mt-10 '>
            <h3 className='text-center font-semibold text-[32px] '>6 Reasons why you should choose <span className='primary-text'>Zeoads</span></h3>
