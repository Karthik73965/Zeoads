...
export default function Hero({ }: Props) {
    return (
        <main className='px-20 pt-[72px] mt-10 '>
            <h1 className='text-center text-[56px] font-bold text-[#1F2933]'>Select the Platform to see its Picing.</h1>
            <section className='bg-[#F5F6FA] py-[32px] px-[24px] gap-[16px] mt-5 h-[1413px]'>
                <section className='gap-[24px] border-[1px]  border-[#E4E7EC] p-[16px] flex justify-between rounded-[8px]'>
                    <div className='w-[548px] bg-[#131516] h-[117px] p-[24px] text-white border-[1px] border-[#E4E7EC] rounded-[8px] text-center'>
