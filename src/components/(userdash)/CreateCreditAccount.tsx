    ...
    return (
        <Dialog>
            ...
            <DialogContent className="min-w  p-6 gap-6  h-[412px] ">
                <h2 className="text-[#1F2933] text-[32px]  font-bold">Create Credit Account</h2>
                {/* feilds */}
                <div className=" h-[200px] -mt-10">
                    ...
                    <div className="mt-5">
                        ...
                        <div className="flex mt-3 gap-[16px]">
                            ...
                            <div onClick={() => setcurrency("EUR")} className="h-[40px] text-center   py-[8px] px-[16px] text-[#3E4C59] font-semibold border-[1px] rounded-[4px]">EUR</div>
                            <div onClick={() => setcurrency("TRY")} className="h-[40px] text-center   py-[8px] px-[16px] text-[#3E4C59] font-semibold border-[1px] rounded-[4px]">TRY</div>
