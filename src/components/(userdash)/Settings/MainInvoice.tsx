                ...
                <section className="my-4 bg-white rounded-[8px] p-[24px] border-[1px] border-[#E4E7EC]">
                    ...
                    <div className="mt-5">
                        ...
                        <div className="flex mt-3">
                            <div
                                className={`px-[16px] py-[8px] gap-[16px] flex text-center rounded-[4px] h-[40px] ${selectedModel === "commission" ? "bg-gray-200" : ""
                                    }`}
                            ...
                            <div
                                className={`px-[16px] py-[8px] gap-[16px] flex text-center rounded-[4px] h-[40px] ${selectedModel === "non-commission" ? "bg-gray-200" : ""
                                    }`}
                        ...
                        <div className="mt-5">
                            ...
                            <div className="flex mt-3 gap-[16px]">
                                <button
                                    className={`px-[16px] py-[8px] border-[1px] border-[#4779E8] text-center rounded-[4px] h-[40px] ${selectedCurrency === "USD" ? "bg-gray-200" : ""
                                        }`}
                                ...
                                <button
                                    className={`px-[16px] py-[8px] border-[1px] border-[#4779E8] text-center rounded-[4px] h-[40px] ${selectedCurrency === "INR" ? "bg-gray-200" : ""
                                        }`}
