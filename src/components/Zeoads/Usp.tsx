...
export default function Usp({}: Props) {
  return (
    <main className='mx-5   md:mx-20 mt-20 grid md:flex justify-between'>
        <section className='bg-[#F5F6FA] md:h-[236px]  py-[32px] px-[24px] items-center justify-center  text-center md:w-[384px] rounded-lg'>
