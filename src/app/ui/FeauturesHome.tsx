...
export default function FeauturesHome({ name, image, Heading, description, list }: Props) {
    return (
        <>
            <div className='  md:w-[384px] w-[90vw] md:h-[776px] py-[40px] px-[24px] rounded-2xl  bg-[#171C20]'>
                ...
                <div className='text-[#F5F6FA] mt-10 md:h-[328px]  text-[16px]'>
                ...
                <button className='bg-white text-black flex md:w-[336px]  px-[24px] py-[12px] gap-x-[12px] mt-10 text-center md:h-[48px] rounded-[4px]'>
