...
import { AdminProfileToggle } from './buttons/AdminProfileToggle'
import { AdminNotificationsToggle } from './buttons/AdminNotificationsToggle'
...
export default function AdminMainNav({ }: Props) {
  return (
    <header className='h-[84px] w-full flex justify-between py-[16px] px-[24px]  border-b-[1px] brder-[#E4E7EC]'>
      <h3 className='text-[#171C20] gap-[4px] mt-2 flex font-semibold text-[20px]'><div>Good Morning! Admin</div> <img className='w-[32px] -mt-5 ' src='/home/handshake.svg' alt='handshake' /></h3>
